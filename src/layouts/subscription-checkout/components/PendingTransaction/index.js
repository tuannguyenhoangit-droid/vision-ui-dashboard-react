  ...
  const handleCancelTransaction = () => {
    if (pendingTransaction?.id) {
      cancelTransaction(pendingTransaction?.id).then(({ status }) => {
        if (status !== -999) {
          // -999 is the status code for cancel transaction not found
  ...
  return (
    <VuiBox>
      <VuiBox
        ...
        sx={{
          background: linearGradient(bill.main, bill.state, bill.deg),
      ...
      >
        <VuiBox mt={2} mb={2} mx="auto" display="flex" flexDirection="column" alignItems="center">
          <QRCodeSVG
            ...
            level="H"
            size={168}
            value={pendingTransaction?.destinationAddress}
          />
          <VuiBox mt={2} mb={2}>
            <VuiTypography variant="caption" color="white" fontWeight="medium" textAlign="center">
        ...
        <VuiBox mt={4} mb={2}>
          <VuiBox mb={2} display="flex" flexDirection="row" justifyContent="center">
            <VuiTypography variant="caption" color="warning" fontWeight="normal" textAlign="center">
          ...
          <VuiBox mt={2} display="flex" flexDirection="row" justifyContent="center">
            ...
            <VuiTypography variant="caption" color="white" fontWeight="normal" textAlign="center">
              {expiredIn}
            </VuiTypography>
          </VuiBox>
        </VuiBox>
